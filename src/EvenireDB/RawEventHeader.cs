...
namespace EvenireDB
{
    ...
    {
        public readonly ulong EventIdTimestamp;
        public readonly ushort EventIdSequence;
        ...
        public const int SIZE =
            sizeof(ulong) + // event id timestamp
            sizeof(ushort) + // event id sequence
        ...
        private const int EVENT_ID_SEQUENCE_POS = EVENT_ID_TIMESTAMP_POS + sizeof(ulong);
        private const int OFFSET_POS = EVENT_ID_SEQUENCE_POS + sizeof(ushort);
        ...
        {
            Unsafe.As<byte, ulong>(ref buffer[EVENT_ID_TIMESTAMP_POS]) = this.EventIdTimestamp;
            Unsafe.As<byte, ushort>(ref buffer[EVENT_ID_SEQUENCE_POS]) = this.EventIdSequence;
        ...
        {
            this.EventIdTimestamp = BitConverter.ToUInt64(data.Slice(EVENT_ID_TIMESTAMP_POS, sizeof(ulong)));
            this.EventIdSequence = BitConverter.ToUInt16(data.Slice(EVENT_ID_SEQUENCE_POS, sizeof(ushort)));
